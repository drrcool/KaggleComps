...
def categorical_variables(frame):
    """Return the indices for any categorical variables in a dataframe.

    This function takes a dataframe (from pandas for example) and identifies
    any categorical columns and returns an index of just those.
    """
    return list(frame.dtypes[frame.dtypes == "object"].index)
